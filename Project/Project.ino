...
//-------------- Thư viện --------------
#include <SPI.h>                                // Chuẩn giao tiếp SPI
...
#define WIFI_SSID "Tranh Coffee & Tea"                    // ID mạng
#define WIFI_PASSWORD "Tranhcoffee"              // PW

//-------------- Định nghĩa firebase --------------
#define FIREBASE_HOST "da01-46df6-default-rtdb.firebaseio.com/"
#define FIREBASE_AUTH "ETXCZJiBSxqkdCv0X61XsFuO4YeImvaklsHj3L0f"  
...
#define RST_PIN   22                          // Sử dụng chân GPIO5 cho Reset
...
void loop() 
{
  ...
  if(Firebase.getString(fbdo, "/Door/State")) 
  {
    ...
    { 
    //-------------- Trạng thái mở cửa bằng website --------------
